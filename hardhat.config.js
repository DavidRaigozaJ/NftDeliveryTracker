...
if (!isTestEnvironment && !SECOND_PRIVATE_KEY) {
  throw Error("Set the SECOND_PRIVATE_KEY environment variable with your EVM wallet private key")
}
...
module.exports = {
    ...
    mumbai: {
      ...
      accounts:
        process.env.PRIVATE_KEY && process.env.SECOND_PRIVATE_KEY
          ...
          : [],
      chainId: 80001,
      ensAddress: false, // Add this line
      nativeCurrencySymbol: "MATIC",
      nativeCurrencyDecimals: 18,
  ...
  contractSizer: {
    runOnCompile: false,
    only: ["NFTDeliveryTracker", "AutomatedFunctionsConsumer", "FunctionsBillingRegistry"],
  },
  paths: {
    sources: "./contracts",
    tests: "./test",
